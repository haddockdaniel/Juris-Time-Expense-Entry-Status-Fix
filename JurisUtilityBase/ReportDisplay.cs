...
namespace JurisUtilityBase
{
    ...
    {
        public ReportDisplay(DataSet ds, DataSet dt, int flag) // 0 is time only, 1 is exp only, 2 is time and exp
        {
            InitializeComponent();
            if (flag == 0)
            {
                ...
                dataGridView1.Size = new Size(1000, 440);
            }
            if (flag == 1)
            {
                ...
                dataGridView2.Size = new Size(1000, 440);
                dataGridView2.Location = new System.Drawing.Point(12, 25);
